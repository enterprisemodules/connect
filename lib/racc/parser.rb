#
# $Id: 7407774d7da3e3df09053f39c9b120f3f4bfe85c $
#
...
module Racc
  ...
  class Parser
    ...
    Racc_Runtime_Revision = '$Id: 7407774d7da3e3df09053f39c9b120f3f4bfe85c $'

    Racc_Runtime_Core_Version_R = ::Racc::VERSION
    Racc_Runtime_Core_Revision_R = '$Id: 7407774d7da3e3df09053f39c9b120f3f4bfe85c $'.split[1]
    begin
    ...
    def _racc_evalact(act)
      ...
      if act > 0 and act < @shift_n
        ...
        code = catch(:racc_jump) {
          @racc_state.push _racc_do_reduce(act)
          false
        }
        if code
          case code
        ...
        when 0
          unless @racc_user_yerror # HACK: arg[21]    # user_yyerror
            nerr += 1
